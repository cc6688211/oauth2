 ...
 * @版本:1.0
 * @创建人:cc
 * @创建时间:2019年11月18日下午4:05:51
 */

package cn.cc.study.util;
...
public class DigestUtil extends org.springframework.util.DigestUtils {
    ...
    public static String sha1(String srcStr) throws Exception {
        return hash("SHA-1", srcStr);
    }

    public static String sha256(String srcStr) throws Exception {
        return hash("SHA-256", srcStr);
    }

    public static String sha384(String srcStr) throws Exception {
        return hash("SHA-384", srcStr);
    }

    public static String sha512(String srcStr) throws Exception {
        return hash("SHA-512", srcStr);
    }

    public static String hash(String algorithm, String srcStr) throws Exception {

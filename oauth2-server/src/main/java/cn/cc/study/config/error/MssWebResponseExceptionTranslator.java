package cn.cc.study.config.error;
 ...
 * @类名称: MssWebResponseExceptionTranslator
 * @类描述:【类描述】异常翻译
 * @版本:1.0
 * @创建人:cc
 * @创建时间:2019年11月18日下午4:13:40
 */
    ...
    public ResponseEntity < OAuth2Exception > translate(Exception e) throws Exception {
        ...
        if (ase != null) {
            return handleOAuth2Exception(
                    new MssWebResponseExceptionTranslator.UnauthorizedException(e.getMessage(), e));
        }
        ...
        if (ase instanceof AccessDeniedException) {
            return handleOAuth2Exception(
                    new MssWebResponseExceptionTranslator.ForbiddenException(ase.getMessage(), ase));
        }
        ...
        return handleOAuth2Exception(new MssWebResponseExceptionTranslator.ServerErrorException(
